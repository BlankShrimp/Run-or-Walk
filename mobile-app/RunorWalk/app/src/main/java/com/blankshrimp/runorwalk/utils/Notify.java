...
/**
 * Very handy notification helper that I borrowed from my another project called NIce.
 */
public class Notify {
    ...
    public static void createNotificationChannels(Context context) {
        ...
        // CHANNEL 1
        CharSequence ch_1_name = context.getString(R.string.notif_ch_1);
        ...
        // CHANNEL 2
        CharSequence ch_2_name = context.getString(R.string.notif_ch_2);
